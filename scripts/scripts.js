...
function changeModel() {
    ...
    // Check the value of the modelName variable and update it
    if (modelName === 'Model XYZ') {
...
// Add an event listener to the pseudo-button
modelButton.addEventListener("click", changeModel);
...
// Adding an event listener to the pseudo-button
